...
enum {
  ...
  timer_doself_matrix, /* matrix loop */
  timer_doself_force,
  ...
  timer_dopair_matrix, /*matrix loop */
  timer_dopair_force,
  ...
  timer_dosub_self_matrix, /* matrix loop */
  ...
  timer_dosub_pair_matrix, /* matrix loop */
  ...
  timer_do_matrix_ghost, /* matrix loop */
